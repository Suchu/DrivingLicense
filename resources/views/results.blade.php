             ...
             <section id="features" class="container">
              ...
              @foreach($result as $eachresult)
                        ...
                        <tr>
                          ...
                          <td>{{$eachresult->firstname}} {{$eachresult->lastname}}</td>
                          <td>{{$eachresult->code}}</td>
                        ...
                        <button type='submit' class = 'form-button-submit button icon fa-arrow' > <a href="{{url('/')}}"> Back</button>
                        </div>

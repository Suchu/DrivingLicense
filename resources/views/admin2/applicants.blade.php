      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">New Applicants</li>
          </ol>
        </section>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      <tbody>
                        <tr><td class="mailbox-name">&nbsp</td><!-- <td class="mailbox-name"></td> --><th class="mailbox-name">Name</th><th class="mailbox-name"></th><th class="mailbox-name"></th></tr>
                         @foreach($app as $new)
                          @foreach($new->vouchers()->get() as $voucher)
                          @if(($new->status)==1)
                        <tr>
                          ...
                          <td class="mailbox-name"><a href="{{url('admin/detail/'.$new->id)}}">{{$new->firstname}}&nbsp{{$new->lastname}}</a></td>
                          <td class="mailbox-subject"><b>New Applicant Entry</b> - Driving License</td>

                          <td class="mailbox-attachment"></td>
                          <td class="mailbox-date">{{$new->created_at->diffForHumans()}}</td>
                        </tr>
                        @endif
                         @endforeach
                        @endforeach

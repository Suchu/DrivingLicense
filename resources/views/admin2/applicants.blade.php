...
<html>
  <head>
    ...
    <title>DrivingLicense | Applicants</title>
        ...
        <section class="sidebar">
          ...
          <!--   <li>
           ...
           <!--  <li>
            ...
            <li class="treeview">
              <!-- <a href="#"> -->
                 <a href="{{url('admin/new')}}"><i class="fa fa-circle-o"></i> New Applicants</a>
                <a href="{{url('admin/registered')}}"><i class="fa fa-circle-o"></i> Registered Applicants</a>
                <a href="{{url('admin/display')}}"><i class="fa fa-circle-o"></i> Add Applicants</a>
                <i class="fa fa-angle-left pull-right"></i>
              <!-- </a> -->
              <ul class="treeview-menu">
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      <tbody>
                         @foreach($app as $new)
                          @foreach($new->voucher()->get() as $voucher)
                        <tr>
                          <td><input type="checkbox"></td>
                          <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                         
                         
                          <td class="mailbox-name"><a href="read-mail.html">{{$new->firstname}}</a></td>

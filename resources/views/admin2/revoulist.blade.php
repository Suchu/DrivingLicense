      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Renewal Voucher</li>
          </ol>
        </section>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      <tbody>
                         <?php $idArray = []; ?>
                          @foreach($app as $reapp)
                          @foreach($reapp->vouchers as $revoucher)
                           @if(!in_array($revoucher->applicants_id, $idArray) && $revoucher->verification=='verifying')
                          
                          <?php array_push($idArray, $reapp->id);?>

                          <tr><td class="mailbox-name">&nbsp</td><!-- <td class="mailbox-name"></td> --><th class="mailbox-name">Name</th><th class="mailbox-name">Citizenship No.</th><th class="mailbox-name">Voucher ID</th></tr>
                        <tr>
                          <td><input type="checkbox"></td>
                          <!-- <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td> -->
                          <td class="mailbox-name"><a href="#">{{$reapp->firstname}} {{$reapp->lastname}}</a></td>
                          <td class="mailbox-name"><a href="#">{{$reapp->citizenship}}</a></td>
                          <td class="mailbox-name"><a href="#">{{$revoucher->voucher_id}}</a></td>
                          <td class="mailbox-subject"><a href="{{url('admin/revouapprove/'. $revoucher->id)}}"><button><b>Approve</b></button></a></td>

              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                     ...
                     <li class="divider"></li>
                    <li><a href="{{url('admin/applicants')}}">Add Applicants</a></li>
        ...
        <div class="container">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li><a href="{{url('admin2.registered')}}">Registed Applicants</a></li>
          ...
          <section class="content">
            ...
            <div class="box box-default">
             ...
             <div class="box-body">
              @foreach($voucher->applicant()->get() as $eachapplicant)

  
              <h3>Please set exam details for {{$eachapplicant->firstname}}.</h3>
                 
                         <div class ='create-exam'>
                          
                          
                        
                          <form action="{{(url('admin/exam'))}}" method='POST'>
                         
                          <input id="applicant_id" name="_token" type="hidden" value="{{ csrf_token() }}">
                          <input name="applicant_id" type="hidden" value="{{$eachapplicant->id}}">
                              
                          <table id="example2" class="table">
                            <tr>
                              <th><u>Exam Details</u><th></tr>
                            </tr>
                            <tr>
                              <th>Code:</th>
                              <td><input type='text' name='code' value='{{(uniqid('DL'))}}' readonly></td>
                            </tr>
                            <tr>
                              <th>Name:</th>
                              <td><input type='text' name='firstname' value='{{$eachapplicant->firstname}}' readonly></td>
                            </tr>
                            
                              <tr>
                              <th>Venue:</th>
                              <td>
                                {!! Form::select('type', array('0' => 'Please select the venue', 'Pardi HSS' => 'Pardi HSS',
'Mahendra HSS'=> 'Mahendra HSS', 'Prativa HSS' =>'Prativa HSS','JMC'=>'JMC') )!!}                            </tr>
                            <tr>
                              <th>Date:</th>
                          ...
                          <button type="submit" name="approve" class="btn btn-aqua" value="Approve">Approve</button>
                        </form>

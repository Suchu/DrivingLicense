      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">License Holder</li>
          </ol>
        </section>
          ...
          <div class="row">
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">License Holder</h3>
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages">
                    <table class="table table-hover table-striped">
                      <tr><td class="mailbox-name">&nbsp</td><!-- <td class="mailbox-name"></td> --><th class="mailbox-name">Name</th><th class="mailbox-name">License No.</th><th class="mailbox-name"></th></tr>
                        <tr>
                      <tbody>
                        @foreach($app as $licapp)
						@foreach($licapp->license()->get() as $lic)
							@if(($licapp->status)==2)
                          ...
                          <td class="mailbox-name"><a href="#">{!!$licapp->firstname!!}&nbsp{!!$licapp->lastname!!}</a></td>
                          <td class="mailbox-name"><a href="#">{!!$lic->lic_no!!}</a></td>

                          <td class="mailbox-subject"><b>License Holders</b> - Driving License</td>

                          <td class="mailbox-attachment"></td>
                          <td class="mailbox-date">{{$licapp->created_at->diffForHumans()}}</td>
                        </tr>
                        @endif
                         @endforeach
                        @endforeach

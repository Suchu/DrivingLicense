       ...
       <div id="form1">
          <div id="features-wrapper">
             ...
             <section id="features" class="container">
              ...
              <div class="form-row">
                {!! Form::open(array('url'=> 'renew/revoucher', 'files'=>true)) !!}
                {!! Form::hidden('applicants_id', $app->id, array('id' => 'invisible_id'))!!}
...
{!! Form::hidden('applicants_id', $app->id, array('id' => 'invisible_id'))!!}
	{{$app->firstname}}<br/>
	{{$app->license->applicant_id}}<br/>
	{{'Voucher id:'}} <input type='text' name='voucher_id'><br/>
	{{'Voucher image: '}}<input type='file' name='voucher_image'><br/>

            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Sulochana Bhujel</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
           ...
           <!--  <li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('auth/register')}}"><i class="fa fa-circle-o"></i> Create New User</a></li>
                <li><a href="pages/examples/login.html"><i class="fa fa-circle-o"></i> List of User</a></li>

...
<html>
  <head>
    ...
    <title>Driving License | Renew</title>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="{{url('admin/applicants')}}">Renew Entry</a></li>
                    
                    
                    <li class="divider"></li>
                    <li><a href="{{url('admin/display')}}">Registered Applicants</a></li>
                     <li class="divider"></li>
                    <li><a href="{{url('admin/licholder')}}">License Holder</a></li>
                    <li class="divider"></li>
                    <li><a href="{{url('admin/create')}}">Create Renew Applicants</a></li>

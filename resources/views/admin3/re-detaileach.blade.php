...
@foreach($eachdetail->applicants as $eachvoucher)
{{$eachdetail->voucher_id}}
{{$eachvoucher->firstname}}
@endforeach
@endforeach
<!DOCTYPE html>
<html>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="{{url('admin/create')}}">Create New User</a></li>
                    
                    
                    <li class="divider"></li>
                    <li><a href="{{url('admin/display')}}">User Lists</a></li>
                  </ul>
                </li>
              </ul>
        ...
        <div class="container">
          ...
          <section class="content">
            <div class="callout callout-info">
             ...
             <div class="box-body">
            <div class="btn-group">
               <!--  <button id="sample_editable_1_new" class="btn green" onclick="window.location.href='/home/create'">
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <div class='app-btn'>        
                     <input type="button" name="approve" class="btn btn-aqua" value="Approve">
                                
                        
                     <input type="button" name="verify" class="btn btn-danger" value="Not verified">

                         </div> 

                      <div class= 'app-img'>
                        <div class='app-pp'><img src="../dist/img/suchu.jpg"> </div>

              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="{{url('admin/display')}}">Registered Applicants</a></li>
                    <li class="divider"></li>
                    <li><a href="{{url('admin/create')}}">Add Applicants</a></li>
                    ...
                    <table class="table table-hover table-striped">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="mailbox-name"><a href="{{url('admin/detail/'.$voucher->id)}}">{{$new->firstname}}</a></td>
